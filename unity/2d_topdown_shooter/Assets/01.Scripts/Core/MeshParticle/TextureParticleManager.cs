...
public class TextureParticleManager : MonoBehaviour
{
    ...
    public void SpawnShell(Vector3 pos, Vector3 dir)
    {
        ...
        _shellList.Add(new Particle(pos, dir, _meshParticleSystem, quadSize, 0, uvIndex, moveSpeed, slowDownFactor, true));
    }
    ...
    public void SpawnBlood(Vector3 pos, Vector3 dir, float size)
    {
        ...
        _bloodList.Add(new Particle(pos, dir, _meshParticleSystem, quadSize, Random.Range(0, 359f), uvIndex, moveSpeed, slowDownFactor, false));
    }
